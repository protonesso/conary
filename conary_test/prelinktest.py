    ...
    def testPrelink(self):
        ...
        self.addComponent('test:foo=1', fileContents =
            [ ( '/prelinktest', rephelp.RegularFile(
                 ...
                 owner = user, group = group, mode = 0o755) ),
        ...
        self.assertEqual(files.PRELINK_CMD, ('/usr/sbin/prelink', ))
        ...
        try:
            ...
            self.assertEqual(digestlib.sha1(open(binary).read()).hexdigest(),
                    '1114f3a978b60d76d7618dc43aaf207bc999f997')
            self.assertEqual(f.contents.sha1().encode('hex'),
